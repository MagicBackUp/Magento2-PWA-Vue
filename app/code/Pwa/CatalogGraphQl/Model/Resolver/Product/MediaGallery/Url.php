<?php
namespace Pwa\CatalogGraphQl\Model\Resolver\Product\MediaGallery;
...
/**
 * Class Url
 * @package Pwa\CatalogGraphQl\Model\Resolver\Product\MediaGallery
 * @deprecated
 */
    ...
    public function resolve(
        ...
        if (isset($value['image_type'])) {
            ...
            $image = $this->imageHelper
                ->init(
                    $product,
                    sprintf('pwa_%s', $value['image_type']),
